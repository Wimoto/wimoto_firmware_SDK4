...
*       ble_lights_on_ble_evt() from the from the @ref ble_stack_handler callback.
* 
* Author : Shafy
* Date   : 10/19/2013
*
...
typedef struct ble_lights_s
{
    ...
    uint8_t                       uuid_type;
    ble_gatts_char_handles_t      current_light_level_handles;        /**< Handles for light  characteristic. */
    ble_gatts_char_handles_t      light_low_level_handles;          	/**< Handles for light low Level characteristic. */
    ble_gatts_char_handles_t      light_high_level_handles;         	/**< Handles for light high Level characteristic. */
    ble_gatts_char_handles_t      light_alarm_set_handles;  	        /**< Handles for light alarm set characteristic. */
    ble_gatts_char_handles_t      light_alarm_handles;      	        /**< Handles for light alarm characteristic. */
...
*/
uint16_t read_light_level(void);											/**@brief Function for reading light from sensor **/

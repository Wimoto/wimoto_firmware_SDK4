...
int main(void)
{
    ...
    if ( switch_to_dfu || (!bootloader_app_is_valid(DFU_BANK_0_REGION_START)))  
    {
        nrf_gpio_pin_set(LED1);
				NRF_POWER->GPREGRET = 0;                        /* Clear the value of general purpose retention resgister , which was set during DFU */
